...
class Review: Identifiable, Codable {
    ...
    init(id: String? = nil, userId: String, rating: Int, reviewText: String, firmId: String, userInfo: UserModel? = nil, firmInfo: FirmModel? = nil, timestamp: Date) {
        self.id = id
        self.userId = userId
        self.rating = rating
